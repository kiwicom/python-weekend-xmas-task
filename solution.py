...
class TripFinder:
    ...
    def _command_line_argumnet_parser(self) -> dict:
        ...
        parser.add_argument(
            "--bags", type=int, default=0, required=False, help="Number of bags"
        )
        parser.add_argument(
            "--stops", type=int, default=0, required=False, help="Number of stops"
        )
        parser.add_argument(
            "--return",
            action="store_true",
    ...
    def format_results(self) -> None:
        ...
        for trip in self.trips:
            ...
            for flight in trip:
                ...
                flight["arrival"] = flight["arrival"].strftime(self._datetime_format)
        ...
        self.results = sorted(self.results, key=lambda result: result["total_price"])
